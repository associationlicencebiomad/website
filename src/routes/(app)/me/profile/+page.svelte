<script lang="ts">
	...
	let newProfile: LoggedInUser = <LoggedInUser>JSON.parse(JSON.stringify($page.data.user));
	$: edited = JSON.stringify(newProfile) !== JSON.stringify(<LoggedInUser>$page.data.user);
